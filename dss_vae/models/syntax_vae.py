...
class SyntaxVAE(VanillaVAE):
    ...
    def adv_forward(self, input_ret, sem_scale=1.0, syn_scale=1.0, detach=True):
        input_ret['adv_sem'], input_ret['adv_syn'] = None, None
        if sem_scale > 0.0:
    ...
    def rec_forward(self, input_ret, sem_scale=1.0, syn_scale=1.0, detach=True):
        input_ret['rec_sem'], input_ret['rec_syn'] = None, None
        if sem_scale > 0.0:
