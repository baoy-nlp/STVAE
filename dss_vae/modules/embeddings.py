...
class Embeddings(nn.Module):
    ...
    def __init__(self, num_embeddings, embedding_dim, dropout=0.0, add_position_embedding=True, padding_idx=None):
    ...
    @classmethod
    def _add_pos_embedding(cls, x, min_timescale=1.0, max_timescale=1.0e4):
