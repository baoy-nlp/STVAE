...
#python -m preprocess.prepare_raw_set --src_file ${DATA_DIR}/whole.ae.tree --tgt_file ${DATA_DIR}/whole.ae.tree --out_file ${DATA_DIR}/whole.tree.detection.txt --data_mode NAG
#tail -n+10001 ${DATA_DIR}/whole.tree.detection.txt > ${DATA_DIR}/train.pair.tree
#head -10000 ${DATA_DIR}/whole.tree.detection.txt > ${DATA_DIR}/dev.pair.tree
