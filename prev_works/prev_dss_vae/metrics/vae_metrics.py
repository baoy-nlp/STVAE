...
from prev_works.prev_dss_vae import Corpus
...
class SyntaxVaeEvaluator(VaeEvaluator):
    ...
    def evaluate_generation(self, corpus_examples=None, sample_size=50, eval_desc="gen", write_down=True):
        ...
        sample_data = self.vae.generating(sample_size, batch_size=self.eval_batch_size)
        sample_corpus = to_plain_source(sample_data)
