...
from prev_works.prev_dss_vae.structs.dataset import PlainInstance
from prev_works.prev_dss_vae.utils.nn_funcs import word2id, id2word
...
def split_examples(examples):
    ...
    sem_examples = [PlainInstance(src=e.src, tgt=None) for e in examples]
    syn_examples = [PlainInstance(src=e.tgt, tgt=None) for e in examples]
