...
from prev_works.prev_dss_vae.networks.attention import Attention as Attention
from prev_works.prev_dss_vae.networks.rnn_base import RNNBase
...
class RNNDecoder(RNNBase, BaseDecoder):
    ...
    def score_decoding_results(self, scores, tgt_sents_var, norm_by_word=False):
        ...
        tgt_sent_log_scores = tgt_sent_log_scores * (1. - torch.eq(flattened_tgt_sents, self.pad_id).float())
        # 0 is pad
        # (batch_size)
