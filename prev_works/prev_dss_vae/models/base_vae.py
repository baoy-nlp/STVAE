...
from prev_works.prev_dss_vae.utils.tricks import kl_anneal_function
from prev_works.prev_dss_vae.utils.tricks import unk_replace
...
class BaseVAE(nn.Module):
    ...
    def decode_to_sentence(self, ret):
        ...
        sentence_decode_init = self.bridger.forward(src=sentence_decode_init)
    ...
    def compute_kl_loss(self, mean, logv, step=None, kl_weight=None):
